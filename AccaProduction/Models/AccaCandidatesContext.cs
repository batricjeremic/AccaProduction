...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=DESKTOP-PFK93A1\\SQLEXPRESS;Database=Acca Candidates;Trusted_Connection=True;MultipleActiveResultsSet=true");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Polaganja>(entity =>
            {
                ...
                entity.Property(e => e.DatumPolaganja)
